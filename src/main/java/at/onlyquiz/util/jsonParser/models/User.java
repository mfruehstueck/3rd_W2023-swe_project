...
public class User {
    ...
    public User(String userName, String password) {
        ...
        this.selectedProperties = new HashMap<>() {{
            put(User_Properties.LIVEAUDIENCE.getLiveAudience(), false);
        }};
    }
    ...
    public HashMap<String, Boolean> get_selectedQuestionnaires() {
        return selectedQuestionnaires;
    }

    public HashMap<String, Boolean> get_selectedProperties() {
        return selectedProperties;
    }

    public void set_selectedQuestionnaires(HashMap<String, Boolean> selectedQuestionnaires) {
        this.selectedQuestionnaires = selectedQuestionnaires;
    }

    public void set_selectedProperties(HashMap<String, Boolean> selectedProperties) {
