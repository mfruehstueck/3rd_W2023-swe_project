...
import static at.debugtools.DebugColors.ANSI_RED;
import static at.debugtools.DebugColors.ANSI_RESET;
...
public class DebugTools {
    ...
    public static String get(Throwable th, String color) { return MessageFormat.format("{0}{1}::{2}::{3}{4}", color, getClass(th, color), getMethod(th, color), getLineNumber(th, color), ANSI_RESET); }
    public static String getAll(Throwable th, String color) { return MessageFormat.format("{0}{1}::{2}::{3}::{4}{5}", color, getFile(th, color), getClass(th, color), getMethod(th, color), getLineNumber(th, color), ANSI_RESET); }
    ...
    public static String get(Throwable th) { return MessageFormat.format("{0}{1}::{2}::{3}{4}", ANSI_RED, getClass(th), getMethod(th), getLineNumber(th), ANSI_RESET); }
    public static String getAll(Throwable th) { return MessageFormat.format("{0}{1}::{2}::{3}::{4}{5}", ANSI_RED, getFile(th), getClass(th), getMethod(th), getLineNumber(th), ANSI_RESET); }
}
